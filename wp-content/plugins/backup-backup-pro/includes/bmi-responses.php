<?php
  ...
  function bmi_code($code) {
    ...
    $byCode = [
      ...
      '25' => 'Your license key expired, please buy new one or renew [#025].',
      '26' => 'Your server does not have cURL module active, we cannot validate your license, please enable that module in order to make it work, we tried to use alternate validation method but it also failed, most likely due to disabled allow_url_fopen option in your php.ini [#026].',
      '27' => 'Your server does not have cURL module active, we cannot validate your license, please enable that module in order to make it work, we tried to use alternate validation method but it also failed, most likely due to disabled allow_url_fopen option in your php.ini [#027].',
      '28' => 'Your server does not have cURL module active, we cannot validate your license, please enable that module in order to make it work, we tried to use alternate validation method but it also failed, most likely due to disabled allow_url_fopen option in your php.ini [#028].',
      ...
      'r5' => 'The License key for given Product is expired',
      'd1' => 'Coming soon!',
