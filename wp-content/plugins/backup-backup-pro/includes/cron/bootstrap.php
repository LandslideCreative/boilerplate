...
// ── Infrastructure ────────────────────────────────────────────────────────────
if (!defined('BMI_INCLUDES')) return; // sanity check, should never happen
require_once BMI_INCLUDES . '/cron/class-abstract-task.php';
require_once BMI_INCLUDES . '/cron/class-task-manager.php';

// ── Task registration ─────────────────────────────────────────────────────────

use BMI\Plugin\CRON\TaskManager;
use BMI\Plugin\CRON\Tasks\CleanupBackupblissStreamTempFilesTask;
use BMI\Plugin\CRON\Tasks\DeleteLocalBackupsAfterUploadTask;

require_once __DIR__ . '/tasks/class-cleanup-backupbliss-stream-temp-files-task.php';
require_once __DIR__ . '/tasks/class-delete-local-backups-after-upload-task.php';

TaskManager::register(new CleanupBackupblissStreamTempFilesTask());
TaskManager::register(new DeleteLocalBackupsAfterUploadTask());
