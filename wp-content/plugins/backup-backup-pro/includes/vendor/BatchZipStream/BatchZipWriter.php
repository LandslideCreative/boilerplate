...
class BatchZipWriter
{
    ...
    private StreamingCompressor $compressor;
    ...
    public function __construct(
        ...
        $this->compressor = new StreamingCompressor($chunkSize, $compressionLevel);
    ...
    public function addFile(
        ...
        try {
            ...
            if ($compressionMethod === ZipFormat::COMPRESSION_DEFLATE) {
                $result = $this->compressor->compressStream(
                    $source,
                ...
                $result = $this->compressor->storeStream(
                    $source,
                    function (string $chunk): void {
                        $this->writeToStream($chunk);
                    }
            ...
            $bitFlags = ZipFormat::getGeneralPurposeBitFlag($sanitizedFilename, true);
    ...
    public function addFileFromString(
        ...
        $this->addFile($filename, $stream, $compressionMethod, $modificationTime);
    }
