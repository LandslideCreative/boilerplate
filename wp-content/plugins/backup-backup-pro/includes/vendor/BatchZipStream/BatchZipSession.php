...
final class BatchZipSession
{
    ...
    public static function withPersistence(
        ...
        $instance = new self('', $outputPath, $compressionLevel, $chunkSize, $persistence);
        return $instance;
    }
    ...
    public static function withStreamFactory(
        ...
        if ($stateDirectoryOrPersistence instanceof StatePersistenceInterface) {
            $instance = new self('', '', $compressionLevel, $chunkSize, $stateDirectoryOrPersistence);
        } else {
            $instance = new self($stateDirectoryOrPersistence, '', $compressionLevel, $chunkSize);
        }
    ...
    public function addFile(
        ...
        $this->writer->addFile($archivePath, $source, $compressionMethod, $modTime);
    ...
    public function addFileFromString(
        ...
        $this->writer->addFileFromString($archivePath, $content, $compressionMethod);
