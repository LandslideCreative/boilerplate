<?php
  ...
  if (!defined('PCLZIP_READ_BLOCK_SIZE')) {
    define('PCLZIP_READ_BLOCK_SIZE', 8192);
  }
  ...
  if (!defined('PCLZIP_ERR_USER_ABORTED')) define('PCLZIP_ERR_USER_ABORTED', 2);
  if (!defined('PCLZIP_ERR_NO_ERROR')) define('PCLZIP_ERR_NO_ERROR', 0);
  if (!defined('PCLZIP_ERR_WRITE_OPEN_FAIL')) define('PCLZIP_ERR_WRITE_OPEN_FAIL', -1);
  if (!defined('PCLZIP_ERR_READ_OPEN_FAIL')) define('PCLZIP_ERR_READ_OPEN_FAIL', -2);
  if (!defined('PCLZIP_ERR_INVALID_PARAMETER')) define('PCLZIP_ERR_INVALID_PARAMETER', -3);
  if (!defined('PCLZIP_ERR_MISSING_FILE')) define('PCLZIP_ERR_MISSING_FILE', -4);
  if (!defined('PCLZIP_ERR_FILENAME_TOO_LONG')) define('PCLZIP_ERR_FILENAME_TOO_LONG', -5);
  if (!defined('PCLZIP_ERR_INVALID_ZIP')) define('PCLZIP_ERR_INVALID_ZIP', -6);
  if (!defined('PCLZIP_ERR_BAD_EXTRACTED_FILE')) define('PCLZIP_ERR_BAD_EXTRACTED_FILE', -7);
  if (!defined('PCLZIP_ERR_DIR_CREATE_FAIL')) define('PCLZIP_ERR_DIR_CREATE_FAIL', -8);
  if (!defined('PCLZIP_ERR_BAD_EXTENSION')) define('PCLZIP_ERR_BAD_EXTENSION', -9);
  if (!defined('PCLZIP_ERR_BAD_FORMAT')) define('PCLZIP_ERR_BAD_FORMAT', -10);
  if (!defined('PCLZIP_ERR_DELETE_FILE_FAIL')) define('PCLZIP_ERR_DELETE_FILE_FAIL', -11);
  if (!defined('PCLZIP_ERR_RENAME_FILE_FAIL')) define('PCLZIP_ERR_RENAME_FILE_FAIL', -12);
  if (!defined('PCLZIP_ERR_BAD_CHECKSUM')) define('PCLZIP_ERR_BAD_CHECKSUM', -13);
  if (!defined('PCLZIP_ERR_INVALID_ARCHIVE_ZIP')) define('PCLZIP_ERR_INVALID_ARCHIVE_ZIP', -14);
  if (!defined('PCLZIP_ERR_MISSING_OPTION_VALUE')) define('PCLZIP_ERR_MISSING_OPTION_VALUE', -15);
  if (!defined('PCLZIP_ERR_INVALID_OPTION_VALUE')) define('PCLZIP_ERR_INVALID_OPTION_VALUE', -16);
  if (!defined('PCLZIP_ERR_ALREADY_A_DIRECTORY')) define('PCLZIP_ERR_ALREADY_A_DIRECTORY', -17);
  if (!defined('PCLZIP_ERR_UNSUPPORTED_COMPRESSION')) define('PCLZIP_ERR_UNSUPPORTED_COMPRESSION', -18);
  if (!defined('PCLZIP_ERR_UNSUPPORTED_ENCRYPTION')) define('PCLZIP_ERR_UNSUPPORTED_ENCRYPTION', -19);
  if (!defined('PCLZIP_ERR_INVALID_ATTRIBUTE_VALUE')) define('PCLZIP_ERR_INVALID_ATTRIBUTE_VALUE', -20);
  if (!defined('PCLZIP_ERR_DIRECTORY_RESTRICTION')) define('PCLZIP_ERR_DIRECTORY_RESTRICTION', -21);
  if (!defined('PCLZIP_OPT_PATH')) define('PCLZIP_OPT_PATH', 77001);
  if (!defined('PCLZIP_OPT_ADD_PATH')) define('PCLZIP_OPT_ADD_PATH', 77002);
  if (!defined('PCLZIP_OPT_REMOVE_PATH')) define('PCLZIP_OPT_REMOVE_PATH', 77003);
  if (!defined('PCLZIP_OPT_REMOVE_ALL_PATH')) define('PCLZIP_OPT_REMOVE_ALL_PATH', 77004);
  if (!defined('PCLZIP_OPT_SET_CHMOD')) define('PCLZIP_OPT_SET_CHMOD', 77005);
  if (!defined('PCLZIP_OPT_EXTRACT_AS_STRING')) define('PCLZIP_OPT_EXTRACT_AS_STRING', 77006);
  if (!defined('PCLZIP_OPT_NO_COMPRESSION')) define('PCLZIP_OPT_NO_COMPRESSION', 77007);
  if (!defined('PCLZIP_OPT_BY_NAME')) define('PCLZIP_OPT_BY_NAME', 77008);
  if (!defined('PCLZIP_OPT_BY_INDEX')) define('PCLZIP_OPT_BY_INDEX', 77009);
  if (!defined('PCLZIP_OPT_BY_EREG')) define('PCLZIP_OPT_BY_EREG', 77010);
  if (!defined('PCLZIP_OPT_BY_PREG')) define('PCLZIP_OPT_BY_PREG', 77011);
  if (!defined('PCLZIP_OPT_COMMENT')) define('PCLZIP_OPT_COMMENT', 77012);
  if (!defined('PCLZIP_OPT_ADD_COMMENT')) define('PCLZIP_OPT_ADD_COMMENT', 77013);
  if (!defined('PCLZIP_OPT_PREPEND_COMMENT')) define('PCLZIP_OPT_PREPEND_COMMENT', 77014);
  if (!defined('PCLZIP_OPT_EXTRACT_IN_OUTPUT')) define('PCLZIP_OPT_EXTRACT_IN_OUTPUT', 77015);
  if (!defined('PCLZIP_OPT_REPLACE_NEWER')) define('PCLZIP_OPT_REPLACE_NEWER', 77016);
  if (!defined('PCLZIP_OPT_STOP_ON_ERROR')) define('PCLZIP_OPT_STOP_ON_ERROR', 77017);
  if (!defined('PCLZIP_OPT_EXTRACT_DIR_RESTRICTION')) define('PCLZIP_OPT_EXTRACT_DIR_RESTRICTION', 77019);
  if (!defined('PCLZIP_OPT_TEMP_FILE_THRESHOLD')) define('PCLZIP_OPT_TEMP_FILE_THRESHOLD', 77020);
  if (!defined('PCLZIP_OPT_ADD_TEMP_FILE_THRESHOLD')) define('PCLZIP_OPT_ADD_TEMP_FILE_THRESHOLD', 77020); // alias
  if (!defined('PCLZIP_OPT_TEMP_FILE_ON')) define('PCLZIP_OPT_TEMP_FILE_ON', 77021);
  if (!defined('PCLZIP_OPT_ADD_TEMP_FILE_ON')) define('PCLZIP_OPT_ADD_TEMP_FILE_ON', 77021); // alias
  if (!defined('PCLZIP_OPT_TEMP_FILE_OFF')) define('PCLZIP_OPT_TEMP_FILE_OFF', 77022);
  if (!defined('PCLZIP_OPT_ADD_TEMP_FILE_OFF')) define('PCLZIP_OPT_ADD_TEMP_FILE_OFF', 77022); // alias
  if (!defined('PCLZIP_ATT_FILE_NAME')) define('PCLZIP_ATT_FILE_NAME', 79001);
  if (!defined('PCLZIP_ATT_FILE_NEW_SHORT_NAME')) define('PCLZIP_ATT_FILE_NEW_SHORT_NAME', 79002);
  if (!defined('PCLZIP_ATT_FILE_NEW_FULL_NAME')) define('PCLZIP_ATT_FILE_NEW_FULL_NAME', 79003);
  if (!defined('PCLZIP_ATT_FILE_MTIME')) define('PCLZIP_ATT_FILE_MTIME', 79004);
  if (!defined('PCLZIP_ATT_FILE_CONTENT')) define('PCLZIP_ATT_FILE_CONTENT', 79005);
  if (!defined('PCLZIP_ATT_FILE_COMMENT')) define('PCLZIP_ATT_FILE_COMMENT', 79006);
  if (!defined('PCLZIP_CB_PRE_EXTRACT')) define('PCLZIP_CB_PRE_EXTRACT', 78001);
  if (!defined('PCLZIP_CB_POST_EXTRACT')) define('PCLZIP_CB_POST_EXTRACT', 78002);
  if (!defined('PCLZIP_CB_PRE_ADD')) define('PCLZIP_CB_PRE_ADD', 78003);
  if (!defined('PCLZIP_CB_POST_ADD')) define('PCLZIP_CB_POST_ADD', 78004);
  ...
  if (!class_exists('PclZip')) {
    class PclZip {
      ...
      public function privAddFile($p_filedescr, &$p_header, &$p_options) {
        ...
        // error_log('MEM: ' . memory_get_usage() / 1024 / 1024 . ' - ' . memory_get_usage());
