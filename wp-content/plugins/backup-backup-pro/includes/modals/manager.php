  ...
  <div class="bmi-modal-wrapper no-hpad no-vpad" style="max-width: 750px; max-width: min(750px, 80vw);">
    ...
    <div class="bmi-modal-content">
      ...
      <div class="premium-fields">
        <input type="text" autocomplete="off" id="premium-license" class="bmi-text-input"<?php echo $this->data('l') ?> placeholder="Please enter your license key here!"<?php echo $this->data('d'); ?>>
