	...
	<div class="pagination page-select">
		<?php if( $current_page!=1 ) { ?>
			<div class="pagination-back">
				<a href="<?php echo get_pagenum_link($current_page-1); ?>"><span class="visually-hidden">Back</span></a>
			</div>
		<?php } else { ?>
		...
		<?php if( $current_page!=$max_pages ) { ?>
			<div class="pagination-next">
				<a href="<?php echo get_pagenum_link($current_page+1); ?>"><span class="visually-hidden">Next</span></a>
			</div>
		<?php } else { ?>
